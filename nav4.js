// Complete Category Sidebar with ALL Subcategories
(function() {
    ...
    let mainToggle = null;
    toggles.forEach(t => {
        if (t.textContent.includes('Toutes les')) mainToggle = t;
    });
    ...
    // Remove old
    const oldSidebar = document.getElementById('complete-sidebar');
    const oldOverlay = document.getElementById('complete-overlay');
    ...
    // Create sidebar with ALL categories from your site
    ...
    sidebar.innerHTML = `
        <div style="background:rgb(109,158,235); color:white; padding:15px 20px; display:flex; justify-content:space-between; align-items:center; position:sticky; top:0;">
            <h3 style="margin:0; font-size:18px;">Toutes les catégories</h3>
            <button id="close-complete" style="background:none; border:none; color:white; font-size:24px; cursor:pointer;">×</button>
        </div>
        <ul style="list-style:none; padding:0; margin:0;">
            ...
            <li style="border-bottom:1px solid #eee;">
                <div style="padding:15px 20px; display:flex; justify-content:space-between; align-items:center;">
                    ...
                    <span class="toggle-complete" style="cursor:pointer; font-size:20px; font-weight:bold; width:30px; height:30px; display:flex; align-items:center; justify-content:center;">+</span>
                </div>
    ...
    console.log('Complete sidebar with ALL subcategories loaded');
})();
